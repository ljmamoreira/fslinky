...
%-------------------------------------------------------------Desenhar as Bolas------------------------------------------------------------%
\draw [fill=white] (bola2) circle (.5) node[draw=none,inner sep = 0,scale=2,text=black]{};
\draw [fill=white] (bola3) circle (.5) node[draw=none,inner sep = 0,scale=2,text=black]{};
\draw [fill=white] (bola4) circle (.5) node[draw=none,inner sep = 0,scale=2,text=black]{};
