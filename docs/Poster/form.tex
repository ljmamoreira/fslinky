...
\mola{3}{-1.5}{3mm}{3mm}
\node[anchor=west] at (-1.5,3) {\textbf{\boldmath$0$}};
\node[anchor=west] at (-1.5,-1.5) {\textbf{\boldmath$1$}};
\node[anchor=west] at (-1.5,-4) {\textbf{\boldmath$2$}};
\node[xshift=-1.5cm,anchor=west] at (-1.5,-8) {\textbf{\boldmath$N-1$}};
